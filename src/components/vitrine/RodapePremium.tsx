    ...
    <footer className="bg-slate-900 text-slate-400">
      ...
      <div className="border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', title: 'Frete Grátis', desc: 'Nas compras acima de R$ 200' },
            { icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', title: 'Entrega Rápida', desc: 'Produtos em estoque' },
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div>
            ...
            <p className="text-xs">Atacado & Varejo de peças para motos. Qualidade e confiança desde 2010.</p>
          </div>
          <div>
            <h4 className="font-bold text-white text-xs uppercase tracking-wider mb-3">Categorias</h4>
            <div className="space-y-1.5 text-xs">
              <p><a href="/vitrine/catalogo?categoria=motor" className="hover:text-white">Motor</a></p>
              <p><a href="/vitrine/catalogo?categoria=freios" className="hover:text-white">Freios</a></p>
              <p><a href="/vitrine/catalogo?categoria=rodas-e-pneus" className="hover:text-white">Pneus</a></p>
              <p><a href="/vitrine/catalogo?categoria=acessorios" className="hover:text-white">Acessórios</a></p>
            </div>
          </div>
          <div>
        ...
        <div className="border-t border-white/5 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <p>Marquinho Moto Peças &copy; {ano} — Todos os direitos reservados. CNPJ: 00.000.000/0001-00</p>

  ...
  return (
    <div className="min-h-screen bg-[#F3F6FB]">
      ...
      <BannerCarrossel banners={[
        { id:'1', titulo:'Pecas para sua moto', subtitulo:'Tudo para sua moto com precos de atacado', ctaTexto:'Montar Orcamento', ctaLink:'/vitrine/carrinho', ativo:true },
        { id:'2', titulo:'Oleos, filtros e manutencao', subtitulo:'Oleos, filtros e manutencao para sua moto', ctaTexto:'Ver Oleos', ctaLink:'/vitrine/categoria/oleos-e-fluidos', ativo:true },
        { id:'3', titulo:'Acessorios e equipamentos', subtitulo:'Acessorios e equipamentos para o dia a dia', ctaTexto:'Ver Acessorios', ctaLink:'/vitrine/categoria/acessorios', ativo:true },
      ]} />

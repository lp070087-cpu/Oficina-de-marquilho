...
export default function BalcaoEstoque() {
  ...
  function exportarPDF() {
    const data = view === 'pecas' ? pecasNivel : pecasFiltradas;
    ...
    const filtroLinha = view === 'pecas' && categoriaSelecionada
      ? `<p class="filtro"><strong>Categoria:</strong> ${categoriaSelecionada.nome}${subcategoriaSelecionada ? ' · <strong>Subcategoria:</strong> ' + labelSubcategoria : ''}</p>`
      : '';

...
export default function EstoquePage() {
  ...
  function abrirForm(peca?:Peca){
    if(peca){setForm({nome:peca.nome,codigo:peca.codigo,descricao:peca.descricao||'',subcategoria:peca.subcategoria||subcategoriaSelecionada||'',marca:peca.marca||'',compatibilidade:peca.compatibilidade||'',precoVenda:fmtMoeda(Number(peca.precoVenda)),precoCusto:fmtMoeda(Number(peca.precoCusto)),quantidade:String(peca.quantidade),estoqueMinimo:String(peca.estoqueMinimo),categoriaId:peca.categoriaId});setModal({open:true,peca});}
